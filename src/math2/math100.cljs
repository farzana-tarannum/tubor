      ...
      [:svg {:style {:height "100%"
       ...
       (let [pull (ve 0)]
         [:g
          ...
          [:path {:d (path [-25 0 :l
                            20 0 0 -5  -10 0 0 -10 -3 0
                            0 10 -12 0 0 -5 -2 0 0 10 10 0
                            ])
                  ;; :marker-end (m7/url "i")
                  :stroke (hsl [2 70 70 1])
                  :stroke-width 1
