  ...
  (let [[timer update-time]
    ...
    (let [zoom 4
      ...
      [:div {:style (merge
       ...
       [:div {:style (m7/css
                      [[2 5 3 10 :center :center 10 :rem :column]
                       [1 70 90 .1] []
                       {:gap "1rem"
                        :z-index 2}])}
           ...
           (let [r (* 10.19 20)
             ...
             [:g
              ...
              [:path#rad1 {:d (str (m7/path [0 0 :l
                                             ...
                                             :a r r 0 false false (ve (- r (* r (js/Math.cos (* angle 4)))))  (ve (* r (js/Math.sin (* angle 4))))
                                             ])
                                   "z")
