    ...
    (let [zoom 4
      ...
      [:div {:style (merge
       ...
       [:div {:style (m7/css
        ...
        [m7/x `[= [[:m 2 ~pi] 32]  [[* 2 ~(fix js/Math.PI 4)] 32] [c 32]]]
       ...
       [:div {:style (m7/css
        ...
        [m7/x `[= [:m sin [[:m ~timer ~pi] 32]] ~(fix (js/Math.sin tn) 2)]]
